      ...
      <div class="page-content-wrapper">
        <div class="auto-container">
          ...
          <div class="user-profile-page" style="margin-top: 50px">
            <div class="card" v-if="this.$cookies.get('type')==='Expert'">
              <div class="card-body">
                <div class="row">
                  <div class="col-12 col-lg-7 border-right">
                    <div class="d-md-flex align-items-center">
                      <div class="mb-md-0 mb-3" >
                        <a><img :src="Expert.avatar||'static/images/men2.jpg'" class="rounded-circle shadow" style="height: 200px;width: 200px" alt="" @click="showdialog=true" /></a>
                      ...
                      <div class="ml-md-4 flex-grow-1">
                        <div class="d-flex align-items-center mb-1">
                          <h4 class="mb-0">{{ Expert.name||Institution.name }}</h4>
                        ...
                        <p class="mb-0 text-muted">{{Expert.institution||Institution.city}}</p>
                        <p class="text-primary"><i class='bx bx-buildings'></i>{{Expert.businessscope}}</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-lg-5">
                    <table class="table table-sm table-borderless mt-md-0 mt-3">
                      ...
                      <tr>
                        <th>研究领域:</th>
                        <td>{{ Expert.domain||Institution.domain }}<span class="badge badge-success" style="margin-left: 20px">热门</span>
                        </td>
                      </tr>
                      <tr>
                        <th>邮箱:</th>
                        <td>{{ Expert.email||Institution.email }}</td>
                      </tr>
                      <tr>
                        <th>电话:</th>
                        <td>{{ Expert.phone ||Institution.phone}}</td>
                      </tr>
                      <tr>
                        <th>传真</th>
                        <td>{{ Expert.fax||Institution.phone }}</td>
                      </tr>
                      <tr>
                        <th></th>
            ...
            <div class="card" v-if="this.$cookies.get('type')==='Institution'">
              <div class="card-body">
                <div class="row">
                  <div class="col-12 col-lg-7 border-right">
                    <div class="d-md-flex align-items-center">
                      <div class="mb-md-0 mb-3" >
                        <a><img :src="Institution.avatar||'static/images/men2.jpg'" class="rounded-circle shadow" style="height: 200px;width: 200px" alt="" @click="showdialog=true" /></a>
                        <el-dialog title="更换头像" :visible.sync="showdialog"   width="20%" center >
                          <el-form >
                            <el-form-item  style="text-align: center">
                              <el-upload
                      ...
                      <div class="ml-md-4 flex-grow-1">
                        ...
                        <p class="text-primary"><i class='bx bx-buildings'></i>{{Institution.businessscope}}</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-lg-5">
                    <table class="table table-sm table-borderless mt-md-0 mt-3">
                      ...
                      <tr>
                        <th>研究领域:</th>
                        <td>{{ Institution.domain }}<span class="badge badge-success" style="margin-left: 20px">热门</span>
                        </td>
                      </tr>
                      <tr>
                        <th>邮箱:</th>
                      ...
                      <tr>
                        ...
                        <td v-if="this.$cookies.get('type')==='Expert'&& this.Expert.status===true"><a href="javaScript:;" class="btn btn-outline-secondary ml-auto radius-10">已是专家</a></td>
                        <td v-if="this.$cookies.get('type')==='Expert'&& this.Expert.status===false"><a href="javaScript:;" class="btn btn-outline-secondary ml-auto radius-10">等待审核</a></td>
                        <td v-if="this.$cookies.get('type')==='Institution'&& this.Institution.status===false"><a href="javaScript:;" class="btn btn-outline-secondary ml-auto radius-10">等待审核</a></td>
                        <td v-if="this.$cookies.get('type')==='Institution'&& this.Institution.status===true"><a href="javaScript:;" class="btn btn-outline-secondary ml-auto radius-10">已经审核</a></td>
                        <td v-if="this.$cookies.get('type')==='Normal'"><a href="javaScript:;" class="btn btn-outline-secondary ml-auto radius-10">重新注册专家账户</a></td>
                      </tr>
                      </tbody>
                    </table>
...
<!--              购买的资源好像没有写-->
              ...
              <el-tab-pane label="修改个人信息" name="fourth" v-if="this.$cookies.get('type')==='Expert'"><el-card class="box-card" >
                <div class="form-body">
                  <div class="row">
...
<!--                      </div>-->
              ...
              <el-tab-pane label="修改单位信息" name="fourth" v-if="this.$cookies.get('type')==='Institution'"><el-card class="box-card" >
                <div class="form-body">
                  <div class="row">
                    <div class="col-12 col-lg-5 border-right">
                      <div class="form-row">
                        <div class="form-group col-md-12">
                          <label>机构名</label>
                          <input type="text"  v-model="Institution.name" class="form-control">
                        </div>

                      </div>
                      <div>
                        <label>联系电话</label>
                        <input type="text" v-model="Institution.phone" class="form-control">
                      </div>
                      <div class="form-group">
                        <label>详细地址</label>
                        <input type="text" v-model="Institution.orgaddress" class="form-control">
                      </div>
                      <div class="form-group">
                        <label>传真</label>
                        <input type="text" v-model="Institution.fax" class="form-control">
                      </div>
                    ...
                    <div class="col-12 col-lg-7">
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label>省</label>
                          <input type="text"  v-model="Institution.province" class="form-control">
                        </div>
                        <div class="form-group col-md-6">
                          <label>城市名</label>
                          <input type="text"  v-model="Institution.city" class="form-control">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-12" >
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-12">
                          <label>单位简介</label>
                          <el-input type="textarea" v-model="Institution.businessscope"   rows=6></el-input>
                        </div>
                      </div>
                ...
                <button type="button" class="btn btn-primary btn-block mt-3" style="height: 50px" @click="update_institution_info()"><i class='bx bxs-lock mr-1'></i>确认修改</button></el-tab-pane>
            </el-tabs>
...
export default {
  ...
  created() {
    ...
    if(this.$cookies.get("type")==="Institution") {
      var id = this.$cookies.get("id")
      this.axios({
        method: 'get',
        url: this.GLOBAL.Service_Base_Url + '/institutionservice/institution/getInstitution/' + id,
      }).then(res => {
  ...
  methods: {
    changeavator(){
      ...
      if (this.$cookies.get("type")==="Institution") {
        vm.Institution.id = this.$cookies.get("id")
        this.axios({
          method:'post',
          url:this.GLOBAL.Service_Base_Url+'/institutionservice/institution/updateInstitution',
          data:vm.Institution
        }).then(res=>{
          alert("修改成功")
          this.$cookies.set("avatar", vm.Institution.avatar)
          location.reload()
        })
      }
    ...
    handleAvatarSuccess(res, file) {
      ...
      if (this.$cookies.get("type")==="Institution") {
        this.Institution.avatar=res.data.url
      }
    },
    ...
    update_institution_info(){
      var vm =this
      vm.Institution.id=this.$cookies.get("id")
      vm.Institution.domain=vm.Institution.domain.toString()
      this.axios({
        method:'post',
        url:this.GLOBAL.Service_Base_Url+'/institutionservice/institution/updateInstitution',
        data:vm.Institution
