        ...
        <div style="text-align: center">
          <div class="app-container" >
            ...
            <el-form :inline="true" class="demo-form-inline">
              <el-select v-model="type" placeholder="请先选择用户类型" >
                <el-option
              ...
              <el-form-item v-if="this.type==='Expert'">
                <el-form-item>
              ...
              <el-form-item v-if="this.type==='Institution'">
                <el-form-item>
                  <el-input v-model="expertQuery.name" placeholder="机构名"/>
                </el-form-item>
...
export default {
  ...
  methods: {
    ...
    get_search_institution_frombutton(){
      this.currentPage=1
      this.get_search_Institution()
    },
    ...
    get_search_users(){
      ...
      if(this.type==="Institution") {
        ...
        this.axios({
          method: 'post',
          url: this.GLOBAL.Service_Base_Url + "/institutionservice/institution/pageInstitutionCondition/" + this.currentPage + "/" + this.pagesize,
          //url:"http://192.168.8.103:8001/expertservice/expert/pageExpertCondition/1/8",
          data: this.expertQuery
        }).then(response => {  //请求成功
          vm.total = response.data.data.total
          ...
          for (var i in users) {
            ...
            var UIntro = users[i].intro
            if (users[i].avatar !== "string") {
              var UCover = users[i].avatar||'static/images/resource/news-5.jpg'
            } else {
              var UCover = ""
            }
            var UInstitution = users[i].institution
