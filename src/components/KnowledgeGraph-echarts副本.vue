  ...
  methods: {
    getGraph(){
      this.axios({
        ...
        var myChart = echarts.init(document.getElementById('mynetwork'));
        var option = {
          title: {
            text: 'Les Miserables',
          ...
          legend: [
            {
              // selectedMode: 'single',
              data: this.data1.categories.map(function (a) {
                return a.name;
              })
            }
          ],
          ...
          series: [
            {
              ...
              type: 'graph',
              layout: 'none',
              data: this.data1.nodes,
              links: this.data1.links,
              categories: this.data1.categories,
              roam: true,
              label: {
                position: 'right',
                formatter: '{b}'
